...
class DocConstant(DocItem):
    """A [DocItem][mkdocstrings.handlers.crystal.collector.DocItem] representing a Crystal constant definition."""
...
class DocMethod(DocItem, metaclass=abc.ABCMeta):
    ...
    @property
    def short_name(self):
        """Similar to [rel_id][mkdocstrings.handlers.crystal.collector.DocItem.rel_id], but also includes the separator first, e.g. `#bar(x,y)` or `.baz()`"""
...
class DocInstanceMethod(DocMethod):
    """A [DocMethod][mkdocstrings.handlers.crystal.collector.DocMethod] representing a Crystal instance method."""
...
class DocClassMethod(DocMethod):
    """A [DocMethod][mkdocstrings.handlers.crystal.collector.DocMethod] representing a Crystal class method."""
...
class DocMacro(DocMethod):
    """A [DocMethod][mkdocstrings.handlers.crystal.collector.DocMethod] representing a Crystal macro."""
